    ...
    <div style={{ position: 'relative', display: 'inline-block' }}>
      <span
        ...
        style={{
          ...
          fontSize: '13px', fontWeight: 600, cursor: 'default', userSelect: 'none',
        }}
      >
      ...
      {showTooltip && (
        <div style={{
          ...
          fontSize: '12px', whiteSpace: 'nowrap', zIndex: 10, pointerEvents: 'none',
        }}>
          {tooltipText}
          <div style={{
        ...
        <div>
          <div style={{ borderRadius: '20px', overflow: 'hidden', backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', marginBottom: '12px' }}>
            <img
              ...
              alt={product.name}
              style={{ width: '100%', height: '420px', objectFit: 'cover', display: 'block', filter: isOutOfStock ? 'grayscale(60%)' : 'none' }}
            />
          </div>
          {allImages.length > 1 && (
            ...
            <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                {product.extraProps.map((prop, i) => (
                  <div key={i} style={{ display: 'grid', gridTemplateColumns: '160px 1fr', padding: '12px 0', borderBottom: '1px solid #f3f4f6' }}>
        ...
        {commentsLoading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {comments.map((comment: any, i: number) => (
              <div key={comment.id ?? i} style={{ padding: '20px 24px', borderRadius: '14px', border: '1px solid #e5e7eb', backgroundColor: '#fafafa' }}>
            ...
            {commentSuccess ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    {[1,2,3,4,5].map((star) => (
                      <span
                        ...
                        style={{ fontSize: '28px', cursor: 'pointer', color: star <= commentRate ? '#f59e0b' : '#d1d5db', transition: 'color 0.15s' }}
                      >
                        ★
                      </span>
                    ))}
                ...
                <div
                  ...
                  onClick={() => setIsNameShown(!isNameShown)}
                >
                  <div style={{
